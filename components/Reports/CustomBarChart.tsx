    ...
    return (
        <div className='mx-10 my-20'>
            <div className='flex justify-between'>
                <h2 className='text-2xl font-bold text-black'>2020 Expenditures by Region</h2>
            ...
            <div className="mt-5 flex ">
                <ResponsiveContainer width="100%" height={400}>
                    <BarChart data={data} layout="vertical" margin={{ top: 20, bottom: 5 }}>
                        <CartesianGrid strokeDasharray="3 3" />
                        <XAxis type="number" />
                        <YAxis dataKey="region" type="category" width={150} hide />
                        <Tooltip formatter={(value) => `$${value}M`} />
                        <Legend />
                        <Bar dataKey="expenditure" fill="#05D192" name="Expenditure (in Millions)" barSize={50}>
                            <LabelList dataKey="region" position="insideLeft" fill="#000" fontSize={12} fontWeight="bold" className="uppercase whitespace-nowrap text-xs" />
                        </Bar>
                    </BarChart>
                </ResponsiveContainer>
            </div>
