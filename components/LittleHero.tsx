        ...
        <div>
            <div className='py-1  px-5 md:px-[200px] w-full bg-[#DB2777] flex justify-between items-center'>
                ...
                <div className='flex space-x-2'>
                    ...
                    <p className=' cursor-pointer text-base text-white font-semibold hover:text-green-700 transition duration-500'>PT</p>
                    <p className=' cursor-pointer text-base text-white font-semibold hover:text-green-700 transition duration-500'>ES</p>
                    <p className=' cursor-pointer text-base text-white font-semibold hover:text-green-700 transition duration-500'>SW</p>
                </div>
            </div>
        </div>
    )
