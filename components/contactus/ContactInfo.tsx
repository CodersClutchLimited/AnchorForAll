...
const ContactInfo = () => {
  return (
    <div className="flex flex-wrap justify-center gap-4 p-6">
      {/* Address */}
      <div className="bg-green-700 text-white p-8 rounded-lg w-64 text-center">
      ...
      {/* Phone */}
      <div className="bg-gray-800 text-white p-8 rounded-lg w-64 text-center">
      ...
      {/* Email */}
      <div className="bg-black text-white p-8 rounded-lg w-64 text-center">
