export const AccordionData = [
  {
    title: "Why was the New Africa fonudation Started?",
    content:
  ...
  {
    title: "Does the foundation have foreign donors or any other donors?",
    content:
      "No, New Africa Foundation distinguishes itself by not relying on donations, be it foreign or local.",
      id: 2
  },
  {
    title: "How is the foundation funded?",
    content: "The foundation is funded by our subscribers.",
    id: 3
  },
  {
    title: "Why do you not take donations?",
    content:
  ...
  {
    title: "How can I contribute or support the foundation?",
    content:
  ...
  {
    title: "Do you collaborate with other foundations?",
    content: "We are always available to collaborate with sister foundations in mass donations and community engagement. However, we do not fund or receive funds from other charitable organisations.",
    id: 6
  },
  {
    title: "What charitable projects are most important to you?",
    content: "We are always looking for causes instrumental to the benefit the global community and we support where there is a great need, as such; young children incapable of supporting themselves are always at the forefront of our concerns. Similarly, developing communities into interconnected, self-sustaining nations, brings us immeasurable satisfaction, which edges us closer to cementing our legacy as an everlasting cornerstone for humanity.",
    id: 7
  },
  {
    title: "How can I volunteer?",
    content: "A New Africa Foundation Volunteer is someone that makes a difference to those nearest to them, impacting the lives of the needy in their immediate community.",
    id: 8
  },
];
